<template>
    ...
    <div class="background">
        <div class="disccont border border-2 border-dark rounded-3">
            ...
            <label class="sdisctext">Do you want to create your own cocktail?</label>
            <label class="tdisctext">Try a cocktail that is unique to you and doesn't exist in the world!</label>
        </div>
        <div class="inputcont border border-2 border-dark rounded-3">
            ...
            <input class="alcin dark-input border border-primary rounded-2" type="text" style = "text-align: center; margin-left: 5px; margin-top: 80px; margin-right: 10px;" placeholder="Taste" @input="taste=$event.target.value"/>
